...
The project is split into two independently deployable services — a Spring Boot REST API and a React single-page application — coordinated locally through Docker Compose and a developer-friendly Makefile.
