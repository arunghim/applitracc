    ...
    <div className="tp">
      ...
      <div className="tp__body">
        <div className="tp__content">
          <Link to="/" className="tp__back">← Back</Link>
          ...
          <section className="tp__section">
            ...
            <p>
              Applitracc itself does not sell, share, or monetise your data.
              The only information stored is what you explicitly enter to track
          ...
          <section className="tp__section">
            ...
            <p>
              ...
              authentication, hosting, and infrastructure. These providers
              may collect data such as IP addresses, usage logs, and device
              information independently, subject to their own privacy policies.
              By using Applitracc you acknowledge that such collection may occur.
            </p>
          </section>
